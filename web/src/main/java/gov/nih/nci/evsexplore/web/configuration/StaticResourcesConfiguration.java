...
public class StaticResourcesConfiguration implements WebMvcConfigurer {
  ...
  /**
   * The Constant STATIC_RESOURCES. Need to be explicitly listed to ensure our routes will set the
   * MIME type correctly
   */
  ...
  /**
   * Add handlers for serving static resources from /static/ folder and implement Single Page
